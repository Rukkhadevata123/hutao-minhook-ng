...
game_functions! {
    ...
    CameraBrainFlush => (
        "56 57 48 83 EC 48 48 89 CE E8 ? ? ? ? 48 85 C0 0F 84 ? ? ? ? 8B 4E 6C 89 4C 24 28 48 8B 4E 64 48 89 4C 24 20 48 8D 54 24 20 48 89 C1 E8",
    ),
    SwitchInputDevice => (
        "56 57 48 83 EC ? 48 89 CE 80 3D ? ? ? ? 00 48 8B 05 ? ? ? ? 0F 85 ? ? ? ? 48 8B 88 80 9F 00 00 48 85 C9 0F 84 ? ? ? ? 48 8B 15 ? ? ? ? E8 ? ? ? ? 48 89 C7 48 8B 05 ? ? ? ? 48 8B 88 80 9F 00 00 48 85 C9 0F 84 ? ? ? ? 31 D2 41 B0 01 E8 ? ? ? ? 48 8B 05 ? ? ? ? 48 8B 88 D0 9E 00 00 48 85 C9 0F 84 ? ? ? ? 31 D2 45 31 C0 E8 ? ? ? ? 48 85 FF 74 ? 48 8B 05 ? ? ? ? 48 8B 88 80 9F 00 00 48 85 C9 0F 84 ? ? ? ? E8 ? ? ? ? 80 3D ? ? ? ? 00 0F 85 ? ? ? ? 48 89 F9 89 C2 E8 ? ? ? ? 48 8B 05 ? ? ? ? 48 8B 88 D0 9E 00 00 48 85 C9 0F 84 ? ? ? ? E8 ? ? ? ? 48 8B 8E 98 02 00 00",
    ),
    SetupQuestBanner => (
        "41 57 41 56 56 57 55 53 48 81 EC ? ? ? ? 0F 29 BC 24 ? ? ? ? 0F 29 B4 24 ? ? ? ? 48 89 CE 0F 57 C0 0F 29 84 24 ? ? ? ?",
    ),
    FindGameObject => (
    ...
    EventCameraMove => (
        "41 57 41 56 56 57 55 53 48 83 EC ? 48 89 D7 49 89 CE 80 3D ? ? ? ? 00 0F 85 ? ? ? ? 80 3D ? ? ? ? 00 0F 85 ? ? ? ? 49 8B 96",
    ),
    ShowDamageText => (
        "41 57 41 56 41 55 41 54 56 57 55 53 48 81 EC ? ? ? ? 44 0F 29 AC 24 ? ? ? ? 44 0F 29 A4 24 ? ? ? ? 44 0F 29 9C 24 ? ? ? ? 44 0F 29 94 24 ? ? ? ? 44 0F 29 8C 24 ? ? ? ? 44 0F 29 84 24 ? ? ? ? 0F 29 BC 24 ? ? ? ? 0F 29 B4 24 ? ? ? ? 44 89 CF",
    ),
    DisplayFog => (
    ...
    CraftEntry => (
        "41 56 56 57 53 48 83 EC ? 49 89 CE 80 3D ? ? ? ? 00 0F 84 ? ? ? ? 80 3D ? ? ? ? 00 48 8B 0D ? ? ? ? 0F 85 ? ? ? ? 48 8B 81 A0 A5 00 00",
    ),
    CheckCanOpenMap => (
    ...
    OpenTeam => (
        "48 83 EC ? 80 3D ? ? ? ? 00 75 ? 48 8B 0D ? ? ? ? 80 B9 C7 00 00 00 00 74 ? B9 0C 00 00 00",
    ),
}
